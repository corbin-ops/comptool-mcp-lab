...
export function buildCompPromptPackage(
  ...
  const userPrompt = [
    ...
    "- Redfin/Zillow photos, listing descriptions, status labels, acreage, price facts, and map/location clues are primary evidence for listing/comp quality when captured.",
    "- Use Redfin/Zillow photo and description observations to judge wooded vs cleared/pasture, slope, access, structures, driveway/build pad, utilities, water features, and nearby development.",
    ...
    "- If Redfin/Zillow/Realtor evidence says Off Market, discontinue comping from that page. Do not use it as an anchor/floor/ceiling; treat it as rejected/unrelated and return verify_first or failed/discontinued posture unless another usable active/sold/pending comp is provided.",
